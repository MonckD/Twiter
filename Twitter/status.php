    ...
    <div id="mine">
        ...
        <div class="wrapper-left">
            <div class="sidebar-left">
                ...
                <button class="button-twittear" class="btn btn-primary" data-toggle="modal" data-target="#myModal">
                    <strong>Tweet</strong>
                </button>
                ...
                <div class="box-tweet feed" style="position: relative;">
                    ...
                    <div class="grid-tweet">
                        <a style="position: relative; z-index:1000" href="<?php echo $tweet_user->username;  ?>">
                            <img src="assets/images/users/<?php echo $tweet_user->img; ?>" alt=""
                  ...
                  echo  Tweet::getTweetLinks($qoute);
                            ...
                            <p class="mt-post-tweet">
                                <img src="assets/images/tweets/<?php echo $tweet_real->img; ?>" alt=""
                ...
                if ($tweet_inner->img != null) { ?>
                            ...
                            if($retweet_sign)
                                echo $retweeted_tweet->id;
                                        ...
                                        <span class="home-follow-count"> <?php echo $retweets_count ; ?> </span>
                                        Retweets</i>
                                </div>
                                <?php } ?>
                            ...
                            <div class="grid-reactions">
                                <div class="grid-box-reaction">
                                    <div class="hover-reaction hover-reaction-comment comment"
                                        data-user="<?php echo $user_id; ?>" data-tweet="<?php 
                    if($retweet_sign)
                       echo $retweeted_tweet->id;
                   else  echo $tweet->id; ?>">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h4 class="modal-title">Mon Pop-up</h4>
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                </div>

                <!-- Corps du pop-up -->
                <div class="modal-body" id="tweet2">
                    <div class="text">
