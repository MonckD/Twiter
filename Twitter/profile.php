                ...
                <div class="box-home feed">
                    <div class="container">
                        ...
                        <div class="row justify-content-between">
                            <img class="home-img-user" src="assets/images/users/<?php echo $profileData->img; ?>"
                                alt="">
                                ...
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                 ...
                                 font-size:18px " class="fas fa-times position-absolute"></a>
                                                        ...
                                                        <img id="preview-cover" class="w-100 home-img-cover"
                                                            src="assets/images/users/<?php echo $profileData->imgCover; ?>"
                                                            alt="">
                                                    </div>
                                                </div>
                        ...
                        <div class="row home-loc-link ml-2">
                            ...
                            <div class="col-md-4">
                                <li class=""> <i class="fas fa-map-marker-alt"></i>
                                    <?php echo $profileData->location; ?></li>
                            </div>
                            <?php } ?>
